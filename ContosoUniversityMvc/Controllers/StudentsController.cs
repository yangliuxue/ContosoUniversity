namespace ContosoUniversityMvc.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id, bool? saveChangeError = false)
        {
            ...
            {
                ViewData["ErrorMessage"] = "Delete faild. try again, if the problem persists " +
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            try
            {
               //  throw new DbUpdateException("error",new System.Exception("db update exception"));
